...
A UE5 editor plugin that exposes 239 MCP tools for inspecting and modifying Blueprint assets. Targets **UE 5.6.1** — this is the version the plugin is built and tested against.
